...
/**
 * Generate a unique folder name from contact ID (not email)
 * This ensures each user gets their own folder even if emails change
 */
...
/**
 * Get or create a user-specific folder using contact ID (NOT email)
 * Structure: TurnkiiClientUploads/user_{contactId}/
 */
